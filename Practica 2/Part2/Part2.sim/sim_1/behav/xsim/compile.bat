...
REM
REM Generated by Vivado on Fri Feb 04 09:41:34 -0500 2022
...
echo "xvhdl --incr --relax -prj fun_tb_vhdl.prj"
call xvhdl  --incr --relax -prj fun_tb_vhdl.prj -log xvhdl.log
