...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {RSTREAL}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {RSTREAL}]
set_property PACKAGE_PIN V16 [get_ports {UP}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {UP}]
set_property PACKAGE_PIN W16 [get_ports {DOWN}]					
...
#set_property PACKAGE_PIN T18 [get_ports en[UP]]						
#	set_property IOSTANDARD LVCMOS33 [get_ports en[UP]]
#set_property PACKAGE_PIN W19 [get_ports en[DOWN]]						
#	set_property IOSTANDARD LVCMOS33 [get_ports en[DOWN]]
