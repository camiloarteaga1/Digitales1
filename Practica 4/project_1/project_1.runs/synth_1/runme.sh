...
HD_PWD='D:/1.BIBLIOTECA_SIMON/Escritorio/Practica/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Animation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Animation.tcl
