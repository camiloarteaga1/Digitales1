...
HD_PWD='D:/1.BIBLIOTECA_SIMON/Escritorio/Practica/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Animation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Animation.tcl -notrace
