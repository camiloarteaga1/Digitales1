...
#set_property PACKAGE_PIN V19 [get_ports {outputSF[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {outputSF[3]}]
#set_property PACKAGE_PIN U19 [get_ports {outputSF[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {outputSF[2]}]
#set_property PACKAGE_PIN E19 [get_ports {outputSF[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {outputSF[1]}]
#set_property PACKAGE_PIN U16 [get_ports {outputSF[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {outputSF[0]}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports en[0]]						
	set_property IOSTANDARD LVCMOS33 [get_ports en[0]]
set_property PACKAGE_PIN T18 [get_ports en[1]]						
	set_property IOSTANDARD LVCMOS33 [get_ports en[1]]
set_property PACKAGE_PIN W19 [get_ports en[2]]						
